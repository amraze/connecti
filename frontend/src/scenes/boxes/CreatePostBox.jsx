...
import UserImage from "../../components/UserImageBox";
...
const CreatePostBox = ({ picturePath }) => {
        ...
        <BoxWrapper>
            ...
            {isImage && (
                <Box borderRadius="5px" border={`1px solid ${medium}`} mt="1rem" p="1rem">
                    <Dropzone acceptFiles=".jpg, .jpeg, .png" multiple={false} onDrop={(acceptedFiles) => setImage("picture", acceptedFiles[0])}>
                        {({ getRootProps, getInputProps }) => (
                            <FlexBetween>
                                <Box {...getRootProps()} border={`2px dashed ${palette.primary.main}`} p="1rem" color={palette.mode === "dark" ? "white" : "black"}
